...
include "../backend/mitsubishi.php";
...
<body>
    ...
    <main>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="carForm">
            <input type="text" name="brand" value="<?php echo 'MITSUBISHI' ?>" readonly required>
        ...
        <div class="display-car">
            <table class="display" id="mitsubishi-table" style="table-layout: fixed;">
                <thead>
                ...
                <tbody>
                    <?php
                        $select_cars = mysqli_query($conn, "SELECT * FROM `cars` WHERE make = 'mitsubishi'");
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="mitsubishi.php?delete=<?php echo $row['id']; ?>" class="delete-btn" name="delete" onclick="return confirm('Are you sure you want to delete the item?');"> <i class="fas fa-trash"></i> </a>
                        </td>
                    </tr>
                    <?php
                            };
    ...
    <script src="../asset/js/mitsubishi.js"></script>
</body>
</html>