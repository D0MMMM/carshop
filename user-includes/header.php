<header>
    <a href="../frontend/dashboard.php">ORMOC CAR DEALER</a>
    ...
    <?php if(isset($_SESSION['username'])): ?>
        <span style="color: red;">Welcome, <?php echo htmlspecialchars($_SESSION['username']); ?></span>
    <?php endif; ?>
    <a href="../logout.php" onclick="return confirm('Are you sure to logout?');" id="logout">Log out</a>
</header>